...
const LaundryAnimation: React.FC<LaundryAnimationProps> = ({ 
  ...
  const elements = useMemo(() => {
    const bubbles: AnimationElement[] = Array.from({ length: config.bubbles }, (_, i) => ({
      id: i,
      type: 'bubble',
    ...
    const droplets: AnimationElement[] = Array.from({ length: config.droplets }, (_, i) => ({
      id: i + 100,
      type: 'droplet',
      ...
      variant: Math.random() > 0.6 ? 'large' : Math.random() > 0.3 ? 'medium' : 'small'
    }));

    const pods: AnimationElement[] = Array.from({ length: config.pods }, (_, i) => ({
      id: i + 200,
      type: 'pod',
      ...
      variant: ['blue', 'green', 'purple', 'orange'][Math.floor(Math.random() * 4)]
    }));
  ...
  useEffect(() => {
    if (reduceMotion && containerRef.current) {
      ...
      const allAnimated = containerRef.current.querySelectorAll('[data-animated]');
  ...
  return (
    ...
    >
      <style jsx>{`
        ...
        /* Animations */
        @keyframes float-up {
          0% { transform: translate3d(0, 105vh, 0) scale(0.8); opacity: 0; }
          5% { opacity: 0.9; transform: translate3d(0, 100vh, 0) scale(1); }
          95% { opacity: 0.8; }
          100% { transform: translate3d(0, -10vh, 0) scale(0.9); opacity: 0; }
        }
        ...
        @keyframes droplet-fall {
          ...
          3% { opacity: 1; }
          97% { opacity: 0.7; }
          100% { transform: translate3d(0, 105vh, 0) rotate(10deg); opacity: 0; }
        }
        ...
        @keyframes pod-float {
          ...
          4% { opacity: 1; }
          96% { opacity: 0.9; }
          100% { transform: translate3d(0, -15vh, 0) rotate(180deg); opacity: 0; }
        }
        ...
        /* Bubbles */
        .bubble-element { animation: float-up linear infinite; }
        .bubble-sway { width: 100%; height: 100%; animation: gentle-sway 6s ease-in-out infinite; }
        .bubble {
          width: 100%;
          height: 100%;
          border-radius: 50%;
        ...
        /* Droplets */
        .droplet-element { animation: droplet-fall linear infinite; }
        .droplet {
          width: 100%;
          height: 120%;
          ...
          box-shadow: inset -2px -2px 6px rgba(255,255,255,0.6), 0 2px 8px rgba(0,50,100,0.3);
        }
        .droplet.small { border-radius: 50%; }
        .droplet.medium { border-radius: 50% 50% 50% 60%; }
        .droplet.large { border-radius: 50% 50% 50% 75%; }

        /* Realistic Laundry Pods */
        .pod-element { animation: pod-float linear infinite; }
        .pod-sway { width: 100%; height: 100%; animation: gentle-sway 8s ease-in-out infinite; }
        ...
        .pod.blue {
          --main-gel-color: linear-gradient(135deg, rgba(30,144,255,0.9), rgba(65,105,225,0.8));
          --secondary-gel-color: linear-gradient(135deg, rgba(0,191,255,0.85), rgba(30,144,255,0.75));
          --tertiary-gel-color: linear-gradient(135deg, rgba(173,216,230,0.8), rgba(135,206,235,0.7));
        }

        .pod.green {
          --main-gel-color: linear-gradient(135deg, rgba(34,139,34,0.9), rgba(50,205,50,0.8));
          --secondary-gel-color: linear-gradient(135deg, rgba(0,250,154,0.85), rgba(34,139,34,0.75));
          --tertiary-gel-color: linear-gradient(135deg, rgba(144,238,144,0.8), rgba(152,251,152,0.7));
        }

        .pod.purple {
          --main-gel-color: linear-gradient(135deg, rgba(138,43,226,0.9), rgba(147,112,219,0.8));
          --secondary-gel-color: linear-gradient(135deg, rgba(186,85,211,0.85), rgba(138,43,226,0.75));
          --tertiary-gel-color: linear-gradient(135deg, rgba(221,160,221,0.8), rgba(216,191,216,0.7));
        }

        .pod.orange {
          --main-gel-color: linear-gradient(135deg, rgba(255,140,0,0.9), rgba(255,165,0,0.8));
          --secondary-gel-color: linear-gradient(135deg, rgba(255,69,0,0.85), rgba(255,140,0,0.75));
          --tertiary-gel-color: linear-gradient(135deg, rgba(255,218,185,0.8), rgba(255,215,180,0.7));
        }
