            ...
            <div className="w-full max-w-md mx-auto lg:mx-0">
              <SignIn
                appearance={{
                  elements: {
                    formButtonPrimary:
                      "bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-medium text-sm normal-case shadow-lg hover:shadow-xl transition-all duration-200 border-0",
                    socialButtonsBlockButton:
                      "border-2 border-gray-200 hover:border-orange-300 hover:bg-orange-50/50 transition-all duration-200 text-gray-700 font-medium",
                    ...
                    formFieldInput:
                      "border-2 border-gray-200 focus:border-orange-400 focus:ring-orange-400/20 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-500 transition-all duration-200",
