...
export const SECURITY_CONFIG = {
  ...
  CSP: {
    ...
    SCRIPT_SRC: [
      ...
      ...(process.env.NEXT_PUBLIC_CLERK_DOMAIN ? [process.env.NEXT_PUBLIC_CLERK_DOMAIN.startsWith('http') ? process.env.NEXT_PUBLIC_CLERK_DOMAIN : `https://${process.env.NEXT_PUBLIC_CLERK_DOMAIN}`] : []),
    ],
